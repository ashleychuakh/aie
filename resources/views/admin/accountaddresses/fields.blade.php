...
<!-- Buildingtype Field -->
<div class="form-group col-sm-6">
    {!! Form::label('buildingtype', 'Buildingtype:') !!}
    {!! Form::text('buildingtype', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    <div class="form-actions">
        <div class="row  col-md-offset-0">
            ...
            <a href="{!! route('admin.accountaddresses.index') !!}" class="btn btn-default">Cancel</a>
        </div>
    </div>
</div>
